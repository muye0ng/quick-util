          ...
          <div>
            ...
            <ul className="space-y-1 text-gray-600 text-sm">
              <li className="flex space-x-4">
                <button onClick={scrollToTop} className="hover:opacity-80 transition-opacity bg-transparent focus:outline-none focus:ring-0 focus:ring-offset-0">
                  <Image src="/github.svg" alt="GitHub" width={20} height={20} />
                </button>
                <button onClick={scrollToTop} className="hover:opacity-80 transition-opacity bg-transparent focus:outline-none focus:ring-0">
