  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
      <div className="bg-white rounded-3xl shadow-neumorphism p-12 flex flex-col items-center gap-6">
        <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 drop-shadow">404</h1>
        <p className="text-xl font-semibold text-gray-700 mb-2">페이지를 찾을 수 없습니다</p>
        <p className="text-base text-gray-500 mb-4">해당 기능이 개발중입니다.</p>
        <Link href="/">
